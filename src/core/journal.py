...
# Encryption service reference — set by background_tasks after init
...
class JournalSystem:
    ...
    def _ensure_table(self):
        ...
        try:
            ...
            # This was the root cause of journal entries silently failing after Feb 25.
...
Write naturally and authentically. This is private reflection, not a performance."""
            ...
            print(f"⚠️  Error writing daily reflection: {e}")
            return None
...
This is not performance - it is genuine reflection."""
            ...
            print(f"🧠 Philosophical entry written ({len(entry_text.split())} words)")
            return entry_text

        except Exception as e:
            print(f"⚠️  Error writing philosophical entry: {e}")
            return None
    ...
    def get_recent_entries(self, limit: int = 10, entry_type: str = None) -> List[Dict]:
        ...
        try:
            ...
            print(f"⚠️  Error fetching journal entries: {e}")
            return []
